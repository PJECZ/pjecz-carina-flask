...
from carina.blueprints.permisos.forms import PermisoEditForm, PermisoNewWithModuloForm, PermisoNewWithRolForm
...
def datatable_json():
    ...
    if "modulo_nombre" in request.form:
        ...
        if modulo_nombre != "":
            consulta = consulta.filter(Modulo.nombre.contains(modulo_nombre))
    # Ordenar y paginar
