...
URL_REGEXP = r"^((https|http)?:\/\/)([0-9a-z-_]*(\.[0-9a-z-_]+)*(\.[a-z]+)*(\:[0-9]+)?|((25[0-5]|2[0-4][0-9]|[0-1]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[0-1]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[0-1]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[0-1]?[0-9][0-9]?)))+(\/[0-9a-z%-_]*)*?\/?$"
